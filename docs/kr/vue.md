...
[View output on GitHub](https://github.com/mondayless/devil_documenty/blob/develop/docs/vue.md#template-syntax)
...
[View output on GitHub](https://github.com/mondayless/devil_documenty/blob/develop/docs/vue.md#data)
