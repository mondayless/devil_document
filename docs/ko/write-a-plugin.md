  ...
  plugins: [
    function pageFooter(hook, vm) {
      var footer = [
        ...
        '<span>Proudly published with <a href="https://github.com/mondayless/devil_documenty" target="_blank">docsify</a>.</span>',
        '</footer>',
      ].join('');
  ...
  plugins: [
    function editButton(hook, vm) {
      ...
      hook.beforeEach(function (html) {
        var url =
          'https://github.com/mondayless/devil_documenty/blob/master/docs/' +
          vm.route.file;
