...
In order to have a sidebar, you can create your own `_sidebar.md` (see [this documentation's sidebar](https://github.com/mondayless/devil_documenty/blob/master/docs/_sidebar.md) for an example):
